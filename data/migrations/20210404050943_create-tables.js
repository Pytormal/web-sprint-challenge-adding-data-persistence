exports.up = function (knex) {
  return knex.schema
    ...
    .createTable("tasks", (tbl) => {
      ...
      tbl.bigint("project_id").unsigned().references("project.id");
    })
    .createTable("project_resources", (tbl) => {
      tbl.increments();
      tbl.bigint("project_name").unsigned().references("project.name");
      tbl.bigint("resource_id").unsigned().references("resource.id");
      //   tbl.date('date')
      //   tbl.primary(["project_name", "resource_id", 'date']);
    });
};
